...
class QuantFig(object):
	...
	def _get_trendline(self, date0=None, date1=None, on=None, kind='trend', **kwargs):
		"""
	...
	def add_support(self, date, on='low', mode='starttoend', text=None, **kwargs):
		...
		"""
		d = {'kind': 'support', 'date0': date, 'mode': mode, 'on': on, 'text': text}
		d.update(**kwargs)
		self.trendlines.append(d)
	...
	def add_annotation(self, date, text, on='high',**kwargs):
		"""
